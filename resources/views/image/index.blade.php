...
<div class="max-w-4xl mx-auto mt-10 mb-6">
    <a href="{{ route('images.create') }}" class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700 transition"
        onclick="openImageCreateModal(event, this.href)">
        Add New Image
    </a>
</div>
...
<div id="image-create-modal" class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 hidden">
    <div id="image-create-modal-content" class="bg-white rounded-lg shadow-lg p-6 max-w-lg w-full relative">
        <button onclick="closeImageCreateModal()"
            class="absolute top-2 right-2 text-gray-500 hover:text-black text-2xl">&times;</button>
